...
if opt.source_img:
    ...
    init_latent = modelFS.get_first_stage_encoding(modelFS.encode_first_stage(source_image))  # move to latent space
    ...
    print('Processing {} images from {}'.format(len(os.listdir(opt.source_img_dir)), opt.source_img_dir))
